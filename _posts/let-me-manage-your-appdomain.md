...
The first method, as long we have write privileges over the file or folder, allows us to (over)write a `.config` file placed in the same folder on which the application resides. For example if we want to target an application called `DemoApp.exe` located in `C:\Temp` we should write or modify a `DemoApp.exe.config` file placed in the same application folder. Even though we can backdoor any type of application a good and huge list of Microsoft signed applications, recently published by MrUn1k0d3r, can be found [here](https://github.com/Mr-Un1k0d3r/.NetConfigLoader/blob/main/signed.txt) and used for this purpose.
...
![](/assets/img/let-me-manage-your-appdomain/moneta-benign.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/nautilus-callstack.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/delegatetest-callstack.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/delegatetest-vmmap.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/rtlcreateheap-rwx.jpg)
Figure 5 - `RtlCreateHeap` with RWX flag

![](/assets/img/let-me-manage-your-appdomain/rtlcreateheap-gcinitialize.jpg)
Figure 6 - `RtlCreateHeap` happening during `GC_Initialize`

![](/assets/img/let-me-manage-your-appdomain/delegatetest-rwxalloc.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/defaultdomain-rwxalloc.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/preparemethod-rwxalloc.jpg)
*Figure 9 - Allocating more memory page on the RWX memory region during `PrepareMethod` execution*

![](/assets/img/let-me-manage-your-appdomain/generaterwxmemory-address.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/backdoored-rdcman.jpg)
Figure 11 - `RDCMan.exe` backdoored with `DirtyCLR`

![](/assets/img/let-me-manage-your-appdomain/dirtyclr-messagebox.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/dirtyclr-moneta.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/pesieve-legit.jpg)
*Figure 14 - `PE-sieve` scan on legitimate `RDCMan.exe` execution*

![](/assets/img/let-me-manage-your-appdomain/pesieve-backdoored.jpg)
...
![](/assets/img/let-me-manage-your-appdomain/pesieve-legit-scan.jpg)
*Figure 16 - `PE-sieve` scan report on legitimate `RDCMan.exe` execution*

![](/assets/img/let-me-manage-your-appdomain/pesieve-backdoored-scan.jpg)
